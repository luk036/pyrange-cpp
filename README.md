[![Actions Status](https://github.com/luk036/pyrange-cpp/workflows/MacOS/badge.svg)](https://github.com/luk036/pyrange-cpp/actions)
[![Actions Status](https://github.com/luk036/pyrange-cpp/workflows/Windows/badge.svg)](https://github.com/luk036/pyrange-cpp/actions)
[![Actions Status](https://github.com/luk036/pyrange-cpp/workflows/Ubuntu/badge.svg)](https://github.com/luk036/pyrange-cpp/actions)
[![Actions Status](https://github.com/luk036/pyrange-cpp/workflows/Style/badge.svg)](https://github.com/luk036/pyrange-cpp/actions)
[![Actions Status](https://github.com/luk036/pyrange-cpp/workflows/Install/badge.svg)](https://github.com/luk036/pyrange-cpp/actions)
[![codecov](https://codecov.io/gh/luk036/pyrange-cpp/branch/master/graph/badge.svg)](https://codecov.io/gh/luk036/pyrange-cpp)

<p align="center">
  <img src="https://repository-images.githubusercontent.com/254842585/4dfa7580-7ffb-11ea-99d0-46b8fe2f4170" height="175" width="auto" />
</p>

# PyRange (modified from ModernCppStarter)
...
- Replace all occurrences of "PyRange" in the relevant CMakeLists.txt with the name of your project
  - Capitalization matters here: `PyRange` means the name of the project, while `pyrange` is used in file names.
  - Remember to rename the `include/pyrange-cpp` directory to use your project's lowercase name and update all relevant `#include`s accordingly.
...
The documentation is automatically built and [published](https://luk036.github.io/pyrange-cpp) whenever a [GitHub Release](https://help.github.com/en/github/administering-a-repository/managing-releases-in-a-repository) is created.
